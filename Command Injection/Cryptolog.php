...
$opt=$_POST['opt'];
$opt = filter_input(INPUT_POST, 'opt', FILTER_SANITIZE_STRING); $lsid = filter_input(INPUT_POST, 'lsid', FILTER_SANITIZE_NUMBER_INT); $sharetype = filter_input(INPUT_POST, 'lssharetype', FILTER_SANITIZE_STRING); $remoteaddress = filter_input(INPUT_POST, 'lsremoteaddress', FILTER_VALIDATE_IP); $sharefolder = filter_input(INPUT_POST, 'lssharefolder', FILTER_SANITIZE_STRING); $user = filter_input(INPUT_POST, 'lsuser', FILTER_SANITIZE_STRING); $pass = filter_input(INPUT_POST, 'lspass', FILTER_SANITIZE_STRING); $domain = filter_input(INPUT_POST, 'lsdomain', FILTER_SANITIZE_STRING);
